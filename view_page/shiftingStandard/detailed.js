...
class PageForm extends Component {
   ...
   */
    passHandle=()=>{
     ...
     console.log(this.tableRef.getSelectData())
   }
  ...
  render() {
    ...
    return (
      <ScrollView style={{padding:8,backgroundColor:"#fff"}}>
        ...
        <View>
            <Text style={{marginTop:8,marginBottom:4,fontSize:16,fontWeight:'bold'}}>请选择需要移库的记录行</Text>
        </View>
            ...
            return (
              <Flex>
                ...
                <Flex.Item style={{flex:8,paddingBottom:5,paddingLeft:2,paddingRight:2}}>
                  <View>
                    <Text numberOfLines={1} style={{textAlign:'left',fontWeight:'bold'}}>库位</Text>
                  </View>
                </Flex.Item>
                <Flex.Item style={{flex:8,paddingBottom:5,paddingLeft:2,paddingRight:2}}>
                ...
                <Flex.Item style={{flex:8,paddingBottom:5,paddingLeft:2,paddingRight:2}}>
                  <Text numberOfLines={1} style={{textAlign:'left',fontWeight:'bold'}}>批次号</Text>
                </Flex.Item>
                <Flex.Item style={{flex:8,paddingBottom:5,paddingLeft:2,paddingRight:2}}>
                  <Text numberOfLines={1} style={{textAlign:'left',fontWeight:'bold'}}>数量</Text>
                </Flex.Item>
                <Flex.Item style={{flex:8,paddingBottom:5,paddingLeft:2,paddingRight:2}}>
